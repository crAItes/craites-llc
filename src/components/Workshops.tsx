...
const workshops = [
  {
    ...
    duration: "Half Day",
    audience: "All Levels",
    description: "Learn to craft compelling fictional characters using AI tools. From backstories to personality traits, discover how to bring your creative visions to life.",
    topics: ["Character Design Prompts", "Personality Generation", "Visual Character Creation"],
  },
  {
    icon: Target,
    ...
    description: "Build intelligent AI agents that automate workflows, handle customer interactions, and drive operational efficiency across your organization.",
    topics: ["Agent Architecture", "Workflow Automation", "Integration Strategies"],
  },
  {
    icon: Rocket,
    ...
    description: "Accelerate your web development process using AI-powered tools. Learn to design, prototype, and build modern websites faster than ever before.",
    topics: ["AI-Assisted Coding", "Rapid Prototyping", "Design Generation"],
  },
];
